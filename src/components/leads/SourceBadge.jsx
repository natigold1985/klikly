...
const SOURCE_CONFIG = {
  ...
  website:   { icon: Globe,           label: 'מהאתר',     bg: '#6366F1', text: '#fff' },
  course:    { icon: User,            label: 'קורס צילום', bg: '#7C3AED', text: '#fff' },
  photo:     { icon: Phone,           label: 'צילום',      bg: '#0F766E', text: '#fff' },
...
const KEYWORD_MAP = [
  ...
  ['קורס',         'course'],
  ['course',       'course'],
  ['natigold.com', 'website'],
  ['event-photography', 'website'],
  ['looking-for-an-event-photographer', 'website'],
  ['צילום',        'photo'],
  ['photography',  'photo'],
  ['פייסבוק',      'facebook'],
  ['facebook',     'facebook'],
